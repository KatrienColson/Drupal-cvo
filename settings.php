 ...
 * its location.
 */
$settings['config_sync_directory'] = 'jdsfjsqljflqsjfmqd';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_garage_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_garage_dd.inc';
}
// </DDSETTINGS>
